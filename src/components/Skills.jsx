...
const Skills = () => {
    return (
        <div id="skills" style={{ marginBottom: '40px', marginTop: '60px' }}>
            ...
            <div className="stack-grid">
                ...
                <div className="stack-item stack-react"><i className="fa-brands fa-react"></i> React</div>
                <div className="stack-item stack-node"><i className="fa-brands fa-node-js"></i> Node.js</div>
